    ...
    <v-container class="ma-0 pa-0" fluid>
        <Uheader/>
            <v-layout class="ma-0 pa-0" wrap>
                <v-flex xs12 lg12>
                    <v-card class="mt-12 pa-0" min-height="510" elevation="0">
                        <v-card-title class="justify-center">運搬情報</v-card-title>
                            ...
                            <v-row justify="center" class="ma-0 pa-0">
                                ...
                                <v-col cols="auto" class="mt-6 ml-n4" style="width:50px;">
                                    {{weight}}
                                </v-col>
                                <v-col cols="auto" class="mt-6 ml-n4">
                                    kg以下
                                </v-col>
                            </v-row>
                            ...
                            <!-- 決定ボタンとダイアログ表示 -->
                            <v-row :justify="btnLayout"  v-resize="onResize" class="mb-12">
                                <v-dialog
                                    v-model="dialog"
