			...
			<v-row class="ma-0 pa-0" justify="center">
				<v-col class="ma-0 pa-0" lg="8" cols="12">
					<v-row class="ma-0 pa-0" justify="center">
						...
						<v-col class="ma-0 pa-0">
							<v-row justify="center">
								<v-btn to="#" class="overline lighten-1" :elevation="0" color="white" text>
									<span v-resize='onResize' :class='size'>運営情報</span>
								</v-btn>
							</v-row>
						</v-col>
						<v-col class="ma-0 pa-0">
						...
						<v-col class="ma-0 pa-0">
							<v-row justify="center">
								<v-btn to="/part_top" class="overline lighten-1" :elevation="0" color="white" text>
									<span v-resize='onResize' :class='size'>パートTOPへ</span>
								</v-btn>
							</v-row>
						</v-col>
